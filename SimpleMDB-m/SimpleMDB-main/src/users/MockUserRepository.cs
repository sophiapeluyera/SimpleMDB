...
public class MockUserRepository : IUserRepository
{
    ...
    public MockUserRepository()
    {
        ...
        var usernames = new string[]
        {
            ...
            "William", "Barbara", "Richard", "Patricia"
        };
        ...
        // Add special user "inter" with specific password
        var interPass = MockUserService.Encode("12345678901234567890");
        var interSalt = "";
        var interRole = Roles.USER;
        User interUser = new User(idCount++, "inter", interPass, interSalt, interRole);
        users.Add(interUser);
    }
